									...
									<div class="row justify-content-md-center mb-4">
										<div class="col-md-6">
											...
											<div class="input-group mb-3">
												...
												<input type="text" class="form-control" id="name" placeholder="Please enter your first and last name."required />
										...
										<div class="col-md-6">
											<div class="form-group mb-3">
												...
												<div class="input-group">
													...
													<input type="text" class="form-control" id="email" placeholder="Please enter your email address." aria-describedby="emailHelp" required />
												</div><!--	input-group-->
									...
									<div class="row justify-content-md-center mb-4">
										<div class="col-md-6">
											...
											<div class="input-group mb-3">
												...
												<input type="text" class="form-control" id="subject" placeholder="You may enter a subject of your message (optional)."  />
											</div><!--input-group mb-3-->
										</div><!--col-md-6-->
									</div><!--row justify-content-md-center mb-4-->
									<div class="row justify-content-md-center mb-4">
										<div class="col-md-6">
											...
											<div class="input-group mb-3">
												...
												<textarea class="form-control" rows="5" id="message" placeholder="Please enter your message here." required></textarea>
											</div><!--input-group mb-3-->
										</div><!--col-md-6-->
									</div><!--row justify-content-md-center mb-4-->
									<div class="row justify-content-md-center mb-4">
